	...
	private function prepareFiles(){
        ...
        if($validate){
            ...
            for($i = 0; $i < count($field['name']); $i++){
                ...
                //$imgName = 'jury_of_peers_'.rand(1000, 2000000000).'_'.  rand(500, 215465).$metas['name'] ;
                $rand = 'jury_of_peers_'.rand(1000, 2000000000).'_'.  rand(500, 215465) ;
                ...
                $metas['name'] = $this->generateFileName($this->options['title'], array($metas['old_name'], 'size'=>$metas['size'])) .$rand.'_'. (!empty($metas['extension']) ? "." . $metas['extension'] : "");
