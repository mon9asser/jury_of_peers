    ...
    if($swichType == 0 ){
        ...
        <?php
           ...
           $initCourtroom =  $evaluationApis ->reviews_rating_apis_get_sum_of_program( 
                 " WHERE post_id= {$last_id}  AND program_type=2"
              );
           //likes
...
<div class="moduleCourtRoom" id="">
        <div class="md-content">
            <b style="font-size: 25px;width: 100%;display: block ;"> Judge this Video </b>
            <div class="ratReviews">
                  <b style="width: 100%;display: block ; border-bottom: 1px solid #eee;">
                    <ul class="mainInfoMenu">
                        ...
                        <li aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Video Judgments">
                              <?php
            ...
            <div class="evaluateContainer evaluatevideo">
                <div post-id="<?php echo $last_id ; ?>" style="
                     ...
                     " id="evaluatevideo<?php echo $last_id ; ?>"></div>
            </div> 
         </div> 
</div>        <?php
    }else {
                         ...
                         <script>
                            ...
                            $(document).ready(function () {
                                 $('[data-toggle="tooltip"]').tooltip();
                                   ...
                                   $('#evaluatevideo<?php echo $last_id ; ?>').raty({
