...
<body>
    ...
    <div class="socialinviter" type="crmcontacts"></div>
    <!-- /CONTACT IMPORTER CODE -->
    ...
    <textarea id="txtselectedcontacts"></textarea>
     ...
     <script type="text/javascript">
         var storeImportedContacts = function (data) {
             ...
             var postdata =  {action: "contacts",data:JSON.stringify(socialinviter.contactimporter.getAllContacts().addressbook)};
         ...
         var storeSelectedContacts = function () {
			 var contacts = "";
             var data = socialinviter.crmcontacts.getAllContacts().addressbook;
             var len = data.length;
             for (var i = 0; i < len; i++) {
                 if (i != 0) {
                     contacts += ", "
             ...
             var postdata =  {action: "selectedcontacts",data:JSON.stringify(data)};
             $.post("processor.php", postdata, function (response) {
                //console.log(response);
             });
         }
         var sendSelectedContacts = function () {
			 ...
			 var data =  {
				 ...
				 data:JSON.stringify(socialinviter.crmcontacts.getRecipients()),
    ...
    <script type="text/javascript">
        var licenses = "<?php echo $crmcilicense ?>";
